...
=======
        ...
        <div class="doc-toolbar">
<<<<<<< HEAD
            <form action="" method="GET" style="max-width: 80px;">
                <div class="search-container" style="position: relative; display: flex; align-items: center;">
                    <i class="fa-solid fa-magnifying-glass" style="position: absolute; left: 8px; color: #94a3b8; font-size: 0.7rem;"></i>
...
?>
>>>>>>> 83fa8177c2b3ed4eeb870e361d118c2a57e03a24
                </div>
            </form>
...
=======
                    <?php if (count($documents) > 0): ?>
                        ...
                        <tr>
                            <td style="font-weight: 600; color: #0d283d; opacity: 0.5;">
                                <?php echo $row['DocID']; ?>
                            </td>
                            <td>
                                <?php
...
?>
                                    <a href="<?php echo htmlspecialchars($row['DocImage']); ?>" target="_blank" title="View Document">
                                        <?php if ($isImage): ?>
                                            <img src="<?php echo htmlspecialchars($row['DocImage']); ?>" alt="Preview" style="width: 42px; height: 42px; object-fit: cover; border-radius: 8px; border: 1px solid rgba(0,0,0,0.05);">
                                        <?php
            else: ?>
                                            <i class="fa-regular fa-file-pdf" style="font-size: 1.2rem; color: #ef4444;"></i>
                                        <?php
            endif; ?>
                                    </a>
                                <?php
                            ...
                            <td style="white-space: nowrap;"><?php echo date('m/d/Y', strtotime($row['DocDate'])); ?></td>
                            <td><?php echo htmlspecialchars($row['Office']); ?></td>
                            <td><?php echo htmlspecialchars($row['Subject']); ?></td>
                            <td style="font-style: italic; opacity: 0.8;"><?php echo htmlspecialchars($row['ReceivedBy'] ?: 'None'); ?></td>
                            <td>
...
<<<<<<< HEAD
                                    ...
                                    <a href="delete_document.php?id=<?php echo $row['DocID']; ?>" class="action-btn delete" title="Delete" onclick="return confirm('Are you sure you want to delete this document?');">
